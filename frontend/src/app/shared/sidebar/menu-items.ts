...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'Tablero', icon: 'mdi mdi-gauge', class: 'has-arrow', label: '4', labelClass: 'label label-rouded label-themecolor pull-right', extralink: false,
        submenu: [
            { path: '/dashboard/dashboard1', title: 'Habitaciones', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
            { path: '/dashboard/dashboard2', title: 'Consumo', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
